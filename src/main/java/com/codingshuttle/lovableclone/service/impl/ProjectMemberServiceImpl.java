...
public class ProjectMemberServiceImpl implements ProjectMemberService {
    ...
    public List<MemberResponse> getAllMembers(Long projectId) {
        return projectMemberMapper.toMemberResponseList(projectMemberRepository.findByProjectId(projectId));
    }
    ...
    public MemberResponse updateMemberRole(Long projectId, Long userId, UpdateMemberRoleRequest updateMemberRoleRequest) {
        ProjectMember projectMember = projectMemberRepository.findById(new ProjectMemberId(projectId,userId)).orElseThrow();
